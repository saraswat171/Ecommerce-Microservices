...
function Header() {
  return (
    <>
      <Stack sx={{ width: '100% ', height: '90px', backgroundColor: 'white' }}>
        <Stack height={"90px"} sx={{ bgcolor: "white" }} justifyContent={"center"}  >
          <Stack justifyContent="space-between" direction={"row"}>
            ...
            <Stack width="600px" justifyContent='space-between' direction={"row"} alignItems={"center"}>
              ...
              <Stack width={"300px"} direction={"row"} justifyContent={"flex-end"} mr={'60px'} gap={'20px'} alignItems={'center'}>
